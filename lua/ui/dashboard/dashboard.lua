...
local function generate_content(win_width, win_height)
  ...
  local total_content_height = #logo + 5 + (#buttons * 2)
...
local function update_dashboard(buf, win)
  ...
  api.nvim_buf_set_lines(buf, 0, -1, false, generate_content(win_width, win_height))
...
function M.setup()
  ...
  local keymaps = {
    { "j", function() next_button(buf) end },
    { "<Down>", function() next_button(buf) end },
    { "k", function() prev_button(buf) end },
    { "<Up>", function() prev_button(buf) end },
    { "<Tab>", function() next_button(buf) end },
    { "<S-Tab>", function() prev_button(buf) end },
    ...
    { "pS", function() vim.cmd("Lazy show") end },
    { "q", function() vim.cmd("q") end },
    { "gg", function() goto_button(buf, 1) end },
    { "G", function() goto_button(buf, #buttons) end },
  }
